...
$(combo_2nd_arch_prefix)TARGET_GCC_VERSION := 4.9-cm-12.0
else
...
ifneq ($(filter 4.6 4.6.% 4.7 4.7.% 4.8 4.8.% 4.9 4.9.% 4.9-cm-12.0 4.9-cm-12.0.%, $($(combo_2nd_arch_prefix)TARGET_GCC_VERSION)),)
